...
function init(myarray,element) {
  ...
  function onSelectionChanged(e) {
    ...
    if (node instanceof go.Node) {
      divg.removeClass("col-md-12").addClass("col-md-9");
      divp.removeClass("hidden-md hidden-lg").addClass("col-md-3");

    } else {
      divg.removeClass("col-md-9").addClass("col-md-12");
      divp.removeClass("col-md-3").addClass("hidden-md hidden-lg");
    }
  }
  ...
  myDiagram.nodeTemplateMap.add("U",  
      $(go.Node, "Vertical",
          ...
          ),
          {
            selectionAdornmentTemplate:
                $(go.Adornment, "Auto",
                    { layerName: "Grid" },
                    $(go.Shape, "Diamond",
                        { fill: "#fa8b60",stroke: null, width: 60, height: 60 }),
                    $(go.Placeholder)
                )  // end Adornment
          }
          ...
          ),
          {
            selectionAdornmentTemplate:
                $(go.Adornment, "Auto",
                    { layerName: "Grid" },
                    $(go.Shape, "Square",
                        { fill: "#fa8b60", stroke: null ,width: 50, height: 50 }),
                    $(go.Placeholder)
                )  // end Adornment
          }
  ...
  setupDiagram(myDiagram, myarray);
